                ...
                <section class="content pl-0 pr-0">
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-between">
                            <div class="col-sm-12 text-center mb-3">
                                <h3><span class="badge badge-info">CATEGORIAS DE PROVEEDORES</span></h3>
                            </div>
                            <div class="col-sm-4 col-6">
                                ...
                                <a class="btn btn-primary" style="transform:translateY(-4px);" href="menus/buscar_prov.php" role="button">Buscar Proveedores <i class="fas fa-search"></i></a>    
                            </div>
                            <div class="col-sm-4 col-6">
                                <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-add" onclick='btn_add("proveedor_categoria");'><i class="fas fa-plus"></i> Nueva Categoria</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 mb-2" id="load_data_proveedores_categoria">
                                <!--
                                    <div class="row justify-content-center text-white">
                                        <div class="col mt-4">
                                            <div class="btn_categorias">
                                                ...
                                                <a href="productos_subcategoria.php?idprod=1"><span>Sub categorias <i class="fas fa-arrow-alt-circle-right"></i></span></a>
                                            </div>
                                        </div>
                                        <div class="col mt-4">
                                            <div class="btn_categorias">
                                                ...
                                                <p>Categoria 1</p>
                                                <span><i class="fas fa-3x fa-boxes"></i></span>
                                                <a href="productos_subcategoria.php?idprod=1"><span>Ver sub categorias <i class="fas fa-arrow-alt-circle-right"></i></span></a>
                                            </div>
                                        </div>
                                        <div class="col mt-4">
                                            <div class="btn_categorias">
                    ...
                    <div class="container-fluid modal-body" style="padding:15px;">
                        <div class="row justify-content-center"> 
                            <div class="col-md-12">
                                ...
                                <form id="formulario-proveedores_cat" class="formulario-modal" enctype="multipart/form-data">
                                    <h4 style="margin-bottom:18px; width:80%;">NUEVA CATEGORIA DE PROVEEDORES</h4>
                                        ...
                                        <div class="tab-content row justify-content-center col-12" id="nav-tabContent">
                                            ...
                                            <div class="col-md-9 col-12 tab-pane fade show active" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea type="text" class="form-control" id="inputCOM" name="inputCOM" placeholder="Descripción de la categoría" rows="4"></textarea>
                                                    </div>
                                                </div>
