                ...
                <section class="content pl-0 pr-0">
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-sm-4 col-6">
                                <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-add" onclick='btn_add("producto_subcategoria");'><i class="fas fa-plus"></i> Nueva Sub-Categoria</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-end">
                            ...
                            <div class="col-12 mb-2" id="load_data_productos_subcategoria">
                                <!--
                    ...
                    <div class="container-fluid modal-body" style="padding:15px;">
                        <div class="row justify-content-center"> 
                            <div class="col-md-12">
                                ...
                                <form id="formulario-productos_subcat" class="formulario-modal" enctype="multipart/form-data">
                                    <h4 style="margin-bottom:18px; width:80%;">NUEVA SUB-CATEGORIA DE PRODUCTOS</h4>
