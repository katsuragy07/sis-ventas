<?php
    ...
    $query = "SELECT * FROM cotizaciones INNER JOIN clientes ON cotizaciones.clientes_idcliente = clientes.idcliente WHERE idcotizacion='$clave' AND cotizaciones.estado='EMITIDO';";
