<?php
    ...
    $query = "";
    $query .= "UPDATE cotizaciones SET total='$total',clientes_idcliente='$idcliente',usuarios_idusuario='$idusuario',igv='$igv',entrega_vent='$entrega',comprobante_vent='$comprobante',adelanto='$adelanto',p1_cant='$cant1',p1_pu='$pu1',p1_st='$st1',p2_cant='$cant2',p2_pu='$pu1',p2_st='$st2',p3_cant='$cant3',p3_pu='$pu3',p3_st='$st3',p4_cant='$cant4',p4_pu='$pu4',p4_st='$st4',p5_cant='$cant5',p5_pu='$pu5',p5_st='$st5'";  
