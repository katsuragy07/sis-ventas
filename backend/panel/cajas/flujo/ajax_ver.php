...
switch($_GET['consulta']){ 
    case 'buscar':
                ...
                $query = "
                            SELECT idmovimiento, idcaja, idusuario, tipo, monto, concepto, detalle, fecha_mov, autoriza, cajas.nombre AS caja_nombre, capital, estado, privilegios, usuarios.nombre AS usu_nombre, usuarios.apellido_pat AS usu_apellido_pat, usuarios.apellido_mat AS usu_apellido_mat
                            FROM movimientos 
                            ...
                            WHERE (DATE(fecha_mov) >= '$inicio') AND (DATE(fecha_mov) <= '$fin') ORDER BY fecha_mov DESC;
                            "; break;
