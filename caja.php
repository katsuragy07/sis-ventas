                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-between">
                            <div class="col-sm-12 text-center mb-3">
                                <h3 style="margin-left:-100px;"><span class="badge badge-info" style="margin-left:120px;">ADMINISTRACIÓN DE CAJA</span></h3>
                            </div>
                        ...
                        <div class="row justify-content-center pb-3">
                            <?php
                                if(substr($accesos['cajas'],0,1)){
                                    echo '
                                        <div class="col mt-2 mb-2">
                                            <a class="btn btn-primary btn-lg menu_btn" href="menus/cajas.php" role="button"><i class="fas fa-2x fa-cash-register"></i><br>CREAR / VER</a>
                                        </div>
                                    ';
                                }
                                if(substr($accesos['cajas'],1,1)){
                                    echo '
                                        <div class="col mt-2 mb-2">
                                            <a class="btn btn-primary btn-lg menu_btn" href="menus/aperturas.php" role="button"><i class="fas fa-2x fa-balance-scale"></i><br>APERTURA Y CIERRE</a>
                                        </div>
                                    ';
                                }
                                if(substr($accesos['cajas'],2,1)){
                                    echo '
                                        <div class="col mt-2 mb-2">
                                            <a class="btn btn-primary btn-lg menu_btn" href="menus/movimientos.php" role="button"><i class="fas fa-2x fa-money-bill-wave"></i><br>MOVIMIENTOS</a>
                                        </div>
                                    ';
                                }
                            ?>
