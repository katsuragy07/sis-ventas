                ...
                <section class="content pl-0 pr-0">
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-between">
                            <div class="col-sm-12 text-center mb-3">
                                <h3><span class="badge badge-info">ADMINISTRACIÓN DE VENTAS</span></h3>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            <?php
                                if(substr($accesos['ventas'],0,1)){
                                    echo '
                                        <div class="col mt-2 mb-3">
                                            <a class="btn btn-primary btn-lg menu_btn" href="menus/cotizaciones.php" role="button"><i class="fas fa-2x fa-file-invoice-dollar"></i><br>COTIZACIONES</a>
                                        </div>
                                    ';
                                }
                                if(substr($accesos['ventas'],1,1)){
                                    echo '
                                        <div class="col mt-2 mb-4">
                                            <a class="btn btn-primary btn-lg menu_btn" href="menus/venta.php" role="button"><i class="fas fa-2x fa-comments-dollar"></i></i><br>VENTAS</a>
                                        </div>
                                    ';
                                }
                            ?>
