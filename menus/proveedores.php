                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-between">
                            <div class="col-sm-12 text-center mb-3">
                                <h3><span class="badge badge-info">PROVEEDORES</span></h3>
                            </div>
                            ...
                            <div class="col-sm-4 col-6">
                                <button type="button" class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-add" onclick='btn_add("proveedores");'><i class="fas fa-plus"></i> Nuevo Proveedor</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12 mb-1">
                                <form class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 mb-2">
                                        <input class="form-control" id="proveedores_buscar" type="search" placeholder="Buscar Proveedores" aria-label="Search" oninput="proveedor.buscar_proveedor($(this).val());">
                                    </div>
                                    <div class="col-md-2 col-sm-12 mb-2">
                                        <button class="btn btn-block btn-success" type="button" onClick="proveedor.buscar_proveedor($('#proveedores_buscar').val());"><i class="fas fa-search"></i> Buscar</button>
                                    </div>        
                                </form>  
                            </div>
                            ...
                            <div class="col-12 mb-2">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered text-center">
                                        ...
                                        <tbody id="load_data_proveedores">
                                            
                                        </tbody>
                                    </table>
                                </div>
                                <div id="load_table_proveedores"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid modal-body" style="padding:15px;">
                        <div class="row justify-content-center"> 
                            <div class="col-md-12">
                                ...
                                <form id="formulario-proveedores" class="formulario-modal" enctype="multipart/form-data">
                                    <h4 style="margin-bottom:18px;width:80%;">NUEVO PROVEEDOR</h4>
                                        ...
                                        <div class="tab-content row justify-content-center col-12" id="nav-tabContent">
                                            ...
                                            <div class="col-md-9 col-12 tab-pane fade show active" id="nav-general" role="tabpanel" aria-labelledby="nav-general-tab">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputRESP" name="inputRESP" placeholder="Responsable">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="inputDIR" class="col-sm-3 col-form-label">Dirección</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="inputDIR" name="inputDIR" placeholder="Dirección del Proveedor">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
